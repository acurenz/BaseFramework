...
{
    public class EyeColorMap : EntityTypeConfiguration<EyeColor>
    {
        public EyeColorMap()
        {
            this.ToTable("EyeColor");

            this.HasKey(t => t.EyeColorID).Property(t => t.EyeColorID) .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
